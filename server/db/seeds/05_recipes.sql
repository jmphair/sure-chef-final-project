...
INSERT INTO recipes (name, instructions, servings, storage_location, prep_time, cook_time, saved, user_id, food_item_id)
VALUES 
  ...
  4, 'Refrigerator', '10 minutes', '25 minutes', true, 1, 1),
  ...
  4, 'Refrigerator', '10 minutes', '30 minutes', true, 2, 2);